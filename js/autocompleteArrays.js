...
["Gfx.reset","()","F","Clear all rotations, scales and image colour changes."],
["Gfx.rotate","(angle:Float)","F","Rotates image drawing functions."],
["Gfx.scale","(scale, ?scaley)","F","Scales image drawing functions, as it's being drawn. Optionally takes a second argument to scale X and Y seperately."],
["Gfx.pivot","(x:Float, y:Float)","F","Choose a point to pivot image rotations and image scales from. Default is top left corner. You can use Gfx.CENTER, Gfx.LEFT, Gfx.RIGHT, Gfx.TOP and Gfx.BOTTOM here."],
