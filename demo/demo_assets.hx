/** 
  This is a free pack of graphical icons you can use in your own zeedonk games!
  Hope you find it useful!

  All of these icons where created with the Zeedonk Sprite editor, which you 
  can access from the dropdown examples list.  - Terry
**/
...
function update(){
  ...
  Text.display(Text.RIGHT - 5, Text.BOTTOM, "FEEL FREE TO USE IN YOUR OWN GAMES");
}