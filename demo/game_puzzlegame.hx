...
function new() {
  ...
  content[0] = [ 
    "At 8am every weekday, Mona catches the same train, which travels\nat an average of 48 kilometres an hour.", 
    "When Mona leaves her apartment each morning, she takes the lift\nto the ground floor.",
    "Mona puts one teaspoon of sugar in her tea each morning.",
    "Mona has twenty-four pairs of socks. Some of them are grey, and\nsome of them are black.",
    "Mona has two flatmates. One of them always lies, and the other\nalways tells the truth.",
    "Each morning, Mona walks one mile south to the bus stop.",
    "Mona packs herself lunch on one morning out of every three.",
    "When Mona reaches her office in the morning, she catches the\nelevator to the tenth floor."];
  content[1] = [ "Sometimes on the weekends, she goes for a walk to\nthe local market.", 
                "She drinks instant coffee, which she buys in a small jar every\nfortnight.",
                ...
                "Everyone at her workplace has either blue eyes or brown eyes.",
                "For lunch she eats first one grain of rice, then two, then four,\nthen eight and so on.",
                "She pays for her lunch with a note and three coins, and receives\nfour coins in return.",
                "She runs along the corridor with a piece of paper in her hand.",
                "On her train journey, Mona reads the newspaper.",
                "She has two water bottles. One of them holds 500 mililitres,\nand the other holds 600 mililitres.",
                "There are three light switches outside her bathroom, but only one\nis connected to the bathroom light.",
                "Mona's elder flatmate, Rhona, is twice the age that\nthe younger, Ilona, was two years ago."];
  content[2] = [ "One day she finds Rhona lying dead outside her house. There\nare no signs of violence.", 
                "Every day on her lunch break, Mona walks to a park near her\nworkplace.",
                "One afternoon she looks out of the window and sees an unexpected\nbird.",
                ...
                "While walking home one Tuesday evening, she finds a\nbroken straw on the ground.", 
                "One night in late summer she finds a pool of water on\nthe path and walks through, not knowing where it came from."];
  content[3] = [ "When she returns home, she walks up the stairs.", 
                ...
                "For dinner she cooks scrambled eggs. She has twelve eggs of\ndifferent weights, which appear to be identical.",
                ...
                "She takes out a gun and points it at the man, who thanks her."];
  content[4] = [ "Why?", 
                "Assume that Mona is perfectly logical. Does she change her mind?",
                "When does Mona die?",
                "How?",
